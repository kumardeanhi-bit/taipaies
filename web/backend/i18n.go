...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Taipaies console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Taipaies",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Taipaies",
		Exiting:            "Exiting Taipaies...",
		DocUrl:             "https://docs.picoclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Taipaies 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Taipaies",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Taipaies",
		Exiting:            "正在退出 Taipaies...",
