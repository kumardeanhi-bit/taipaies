...
var modelProviderOptionsByName = map[string]ModelProviderOption{
	...
	"zen": {
		...
		SupportsFetch:       true,
		Priority:            45,
		CommonModels:        []string{"gemini-3.1-pro-preview", "gemini-3-flash", "claude-sonnet-4-6", "gpt-5.4"},
	...
	"agentrouter": {
		...
		DefaultAPIBase:      "http://127.0.0.1:8318/v1",
		CreateAllowed:       true,
		DefaultModelAllowed: true,
		Priority:            33,
		CommonModels:        []string{"glm-5.1", "deepseek-v4-flash", "deepseek-v4-pro", "gpt-5.5"},
		httpAPI:             true,
	},
}
