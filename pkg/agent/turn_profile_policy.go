...
func toolUseSystemPromptRule() string {
	return "**Use tools when asked** - When the user explicitly asks you to perform an action, call the appropriate tool. For casual conversation, just reply naturally."
}
